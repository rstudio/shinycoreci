...
apps_deps <- c("base64enc", "Cairo", "clipr", "curl", "DBI", "dbplyr", "DiagrammeR", 
...
apps_deps_map <- list(`001-hello` = "rsconnect", `012-datatables` = "ggplot2", 
    ...
    "RSQLite"), `063-superzip-example` = c("dplyr", "RColorBrewer", 
    "scales"), `082-word-cloud` = c("memoise", "tm", "wordcloud"
    ), `093-plot-interaction-basic` = "ggplot2", `094-image-interaction-basic` = "png", 
    `095-plot-interaction-advanced` = c("ggplot2", "scales"), 
    ...
    "ggplot2"), `112-generate-report` = "rmarkdown", `118-highcharter-births` = c("dplyr", 
    "highcharter", "tidyr"), `121-async-timer` = c("future", 
    "magrittr"), `122-async-outputs` = "future", `123-async-renderprint` = "future", 
    `124-async-download` = "future", `125-async-req` = "future", 
    `126-async-ticks` = "future", `129-async-perf` = c("future", 
    "ggplot2"), `140-selectize-inputs` = "jsonlite", `141-radiant` = "radiant", 
    `143-async-plot-caching` = "ggplot2", `147-websocket` = "shinyjs", 
    `150-networkD3-sankey` = c("networkD3", "shinydashboard"), 
