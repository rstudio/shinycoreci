...
"scales", "sf", "shinyAce", "shinydashboard", "shinyjs", "showtext",
"sysfonts", "systemfonts", "testthat", "tidyr", "tm", "waldo",
"withr", "wordcloud")
apps_deps_map <- list(`001-hello` = "rsconnect", `012-datatables` = "ggplot2",
    ...
    ), `308-sidebar-kitchen-sink` = "lorem", `309-flexdashboard-tabs-navs` = "rmarkdown", `310-bslib-sidebar-dynamic` = c("rversions",
