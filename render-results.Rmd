...
shiny::markdown(
'
* Current [`posit-dev/py-shiny`](https://github.com/posit-dev/py-shiny) status: [![](https://img.shields.io/github/actions/workflow/status/posit-dev/py-shiny/pytest.yaml?branch=main)](https://github.com/posit-dev/py-shiny)
